...
//consol.log(colorList[0]);
//sort the colors
//colorList.sort(); //sorts list alphabetically
...
//colorList.shit(); //removes the first elements
...
//create new array (list) to hold purchased images
var purchasedImages = [];
...
function onImageClick(evt)
{
  ...
  //get the element you clicked on OUT of hte imageListA array and save the clicked image path to a variable so we can use it later
